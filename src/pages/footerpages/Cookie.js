...
<h1 style={{textTransform:'capitalize',color:'#318e29'}}>Cookie Policy for iTruth News</h1>
<div className='textblock'>
<p>At Chick-a-licious, we use cookies to enhance your user experience and to improve the <br/>
...
<p>At Chick-a-licious, we use cookies to improve the performance of our website and to enhance <br/>
...
<h2>Cookies used on Chick-a-licious</h2>
<h3>The following is a list of the types of cookies we use on Chick-a-licious:</h3>
...
<h2>Contact Us</h2>
<p>If you have any questions or concerns about our use of cookies, please contact us at <Link href='/footerpages/Contact' style={{textDecoration:'none',color:'#318e29',padding:'0 10px 0 0'}}>Contact iTruth News</Link></p>
